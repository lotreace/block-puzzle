(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();class p{constructor(e=8){this.size=e,this.grid=Array(e).fill(null).map(()=>Array(e).fill(!1)),this.element=null,this.cellElements=[]}createBoard(){const e=window.innerWidth;let t=50,r=2,s=10;e<400?(t=35,r=1,s=5):e<768&&(t=40,r=2,s=8),this.cellSize=t,this.element=document.createElement("div"),this.element.className="game-board",this.element.style.cssText=`
    ...
    `;for(let s=0;s<t;s++)for(let i=0;i<r;i++){const a=document.createElement("div");this.pattern[s][i]?a.style.cssText=`
          ...
          `:a.style.cssText=`
            ...
            height: ${cellSize}px;
            background-color: transparent;
          `,e.appendChild(a)}return e}static getRandomShapeType(){const e=Object.keys(c.SHAPES);return e[Math.floor(Math.random()*e.length)]}}class u{constructor(){this.shapes=[],this.element=null,this.slots=[]}createElement(){this.element=document.createElement("div"),this.element.className="shape-selector",this.element.style.cssText=`
      display: flex;
    ...
    `;for(let e=0;e<3;e++){const t=document.createElement("div");t.className="shape-slot",t.dataset.slotIndex=e,t.style.cssText=`
      ...
      `,this.element.appendChild(t),this.slots.push(t)}return this.fillSlots(),this.element}fillSlots(){this.slots.forEach((e,t)=>{if(!this.shapes[t]||!this.shapes[t].element||!this.shapes[t].element.parentElement){const r=c.getRandomShapeType(),s=new c(r),i=s.createElement();e.innerHTML="",e.appendChild(i),this.shapes[t]=s}})}getShapeByElement(e){return this.shapes.find(t=>t&&t.element===e)}removeShape(e){const t=this.shapes.indexOf(e);t!==-1&&(this.shapes[t]=null,this.checkAndRefillSlots())}returnShapeToSlot(e){const t=this.shapes.indexOf(e);t!==-1&&this.slots[t]&&(this.slots[t].innerHTML="",this.slots[t].appendChild(e.element))}checkAndRefillSlots(){this.shapes.every(t=>t===null)&&(this.shapes=[],this.fillSlots())}hasAvailableShapes(){return this.shapes.some(e=>e!==null)}getAvailableShapes(){return this.shapes.filter(e=>e!==null)}}class m{constructor(){this.score=0,this.element=null}createElement(){this.element=document.createElement("div"),this.element.className="score-display",this.element.style.cssText=`
      background-color: #2c3e50;
      padding: 20px;
      border-radius: 8px;
      margin-bottom: 20px;
